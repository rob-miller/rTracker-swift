...
// rtm had to remove (nonatomic, unsafe_unretained, readonly) for swift
...
// rtm had to remove readonly for swift
...
// rtm had to remove readonly for swift
@property UIImage *todayBackgroundImage;
...
// rtm had to remove readonly for swift
@property UIImage *notThisMonthBackgroundImage;
