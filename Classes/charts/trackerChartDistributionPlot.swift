...
extension TrackerChart {
    ...
    internal func drawRecentDataIndicatorLine(backgroundValues: [Double]) {
        ...
        switch recentDataIndicatorState {
        case 1:
            lineView.backgroundColor = rTracker_resource.colorSpectrum[0] // red
        case 2:
            lineView.backgroundColor = rTracker_resource.colorSpectrum[1] // green
        case 3:
            lineView.backgroundColor = rTracker_resource.colorSpectrum[2] // blue
        case 4:
            lineView.backgroundColor = rTracker_resource.colorSpectrum[3] // cyan
        case 5:
            lineView.backgroundColor = rTracker_resource.colorSpectrum[4] // yellow
        default:
            break
        }
