...
class TrackerChart: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    internal func fetchDataForValueObj(id: Int, startTimestamp: Int, endTimestamp: Int, excludeEmptyValues: Bool = false) -> [(Date, Double)] {
        ...
        // Optionally exclude empty string values (for time plots to avoid plotting 0 for missing data)
